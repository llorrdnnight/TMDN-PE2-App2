...
echo"<tr><td>".$row['id']."</td><td>".$row['firstName']."</td><td>".$row['lastName']."</td><td>".$row['mailAddress']."</td><td>".$row['phoneNumber']."</td><td>".$row['salary']."</td><td>".$row['birthDate']."</td><td><a href=delete.php?delete=".$row['id']."><img class='resize' src='../images/delete.png'></a><a href=manage.php?edit=".$row['id']."> <img class='resize' src='../images/manage.png'></a></td></tr>";
