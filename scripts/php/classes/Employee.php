...
$sql = "SELECT id FROM timesheets WHERE employee = $employee AND end IS NULL LIMIT 0,1";
$result = $db->query($sql);
...
public static function getLastWorkingSession($employee, $db){
    ...
    $sql = "SELECT * FROM timesheets WHERE end IS NOT NULL AND employee = $employee AND id = (SELECT MAX(id) FROM workinghours WHERE employee = $employee AND end IS NOT NULL)";
    $result = $db->query($sql);
...
public static function getHoursWorkedThisWeek($employee, $db){
    ...
    $sql = "SELECT * FROM timesheets WHERE start BETWEEN '$startOfWeek' AND '$endOfWeek' ";
    $result = $db->query($sql);
